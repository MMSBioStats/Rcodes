...
mean(replicate(2000, pocl_test(
  pocl_simulate(900, a=alph, b=c(0, log(.8))),alpha=0.05)))
...
#Effect size
logOR<-log(1.87)  #log(1.78) for 0.7, log(1.56) for 0.75, log(1.5) for 0.80

pow1 <-
  replicate(1000,
            pocl_Bayes_test(
              pocl_simulate(180, a = alph, b = c(0, logOR)),
              priormu = c(0, log(1.8)),
              priorvar = c(.7 ^ 2, .35 ^ 2)
            ))
