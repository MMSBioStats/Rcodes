...
png("G:/My Drive/ClinicalTrialsMedSchool/2021/plot1.png",height = 400,width = 500)
...
png("G:/My Drive/ClinicalTrialsMedSchool/2021/plot3.png",height = 400,width = 500)
...
colorArea(from=-.7, to=log(.5), (dnorm), mean=postmu1, sd=sqrt(postvar1), col="lightskyblue")
dev.off()
